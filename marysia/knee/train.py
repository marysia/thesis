...
def create_result_dir(modelfn, logme):
    ...
    result_dir = 'KNEE/results/' + os.path.basename(modelfn).split('.')[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelfn', type=str, default='models/P4CNN.py') # change
    parser.add_argument('--trainfn', type=str, default='KNEE/train.npz')
    parser.add_argument('--valfn', type=str, default='/KNEE/valid.npz')
