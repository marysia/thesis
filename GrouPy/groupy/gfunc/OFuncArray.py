...
class OFuncArray(GFuncArray):
    ...
    def __init__(self, v, umin=None, umax=None, vmin=None, vmax=None):
        ...
        super(OFuncArray, self).__init__(v=v, i2g=i2g)
...
def tst():
    ...
    from groupy.garray.O_array import OArray, meshgrid, u_range, v_range, rotation, translation
